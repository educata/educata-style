...
<div class="d-flex flex-column gap-3">
  ${l.map(a=>`<span class="text-${a} user-select-all p-2">.text-${a}</span> <span class="text-${a}-bg bg-${a} user-select-all p-2">.text-${a}-bg</span>`).join("")}
</div>
...
}`,...(c=(i=s.parameters)==null?void 0:i.docs)==null?void 0:c.source}}};const u=["Variations","Colors"];export{s as Colors,n as Variations,u as __namedExportsOrder,g as default};
